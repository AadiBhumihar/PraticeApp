...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback ,GoogleApiClient.ConnectionCallbacks ,
    ...
    ImageButton restraunt_btn, hospital_btn, school_btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        restraunt_btn.setOnClickListener(this);
        hospital_btn.setOnClickListener(this);
        school_btn.setOnClickListener(this);
    }

    private void intilize() {
       restraunt_btn = (ImageButton) findViewById(R.id.buttonresutrantview);
        hospital_btn = (ImageButton)findViewById(R.id.buttonhospitalview);
        school_btn = (ImageButton)findViewById(R.id.buttonschoolView);
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId())
        {
            ...
            case R.id.buttonschoolView:

                break;

            case R.id.buttonhospitalview:
    ...
    private String getUrl(double latitude, double longitude, String nearbyPlace) {
        ...
        googlePlacesUrl.append("&key=" + " AIzaSyD01XNUiEjeMnS49PdLpZ9HYYuvWTP4BS4");
